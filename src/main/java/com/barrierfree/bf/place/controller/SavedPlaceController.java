...
public class SavedPlaceController {
  ...
  @Operation(summary = "장소 저장 목록 생성", description = "사용자가 지정한 이름으로 장소 저장 목록을 생성합니다.")
  @PostMapping
  ...
  @Operation(summary = "내 장소 저장 목록 조회", description = "현재 로그인한 사용자의 장소 저장 목록을 조회합니다.")
  @GetMapping
  ...
  public ApiResponse<SavedPlaceResponse.SavedPlaceSummary> savePlace(
      @Parameter(hidden = true) @AuthenticationPrincipal Long userId,
      @Parameter(description = "장소 저장 목록 ID", example = "1") @PathVariable Long listId,
  ...
  @Operation(summary = "저장된 장소 조회", description = "특정 장소 저장 목록에 담긴 장소들을 조회합니다.")
