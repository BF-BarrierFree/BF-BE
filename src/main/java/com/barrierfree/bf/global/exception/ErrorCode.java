...
public enum ErrorCode {
  ...
  // --- 길찾기 및 경로 검색 관련 에러 (Route) ---
  ROUTE_NOT_FOUND(HttpStatus.NOT_FOUND, "R001", "요청하신 조건으로 이동 가능한 최적의 경로를 찾을 수 없습니다."),
  INVALID_ROUTE_COORDINATES(
      HttpStatus.BAD_REQUEST, "R002", "출발지 또는 도착지의 좌표가 올바르지 않습니다. (예: 바다 위의 좌표)"),
