...
public enum ErrorCode {
  ...
  KAKAO_SERVICE_UNAVAILABLE(
      HttpStatus.SERVICE_UNAVAILABLE, "A003", "카카오 서버가 일시적으로 응답하지 않습니다. 잠시 후 다시 시도해 주세요."),

  // --- 이미지 및 파일 업로드 관련 에러 (Image) ---
  INVALID_IMAGE_FORMAT(
      HttpStatus.BAD_REQUEST, "I001", "지원하지 않는 이미지 형식입니다. (jpg, jpeg, png, webp 등만 허용)"),
  IMAGE_UPLOAD_FAILED(
      HttpStatus.INTERNAL_SERVER_ERROR, "I002", "이미지 업로드 중 서버 오류가 발생했습니다. 잠시 후 다시 시도해 주세요.");
