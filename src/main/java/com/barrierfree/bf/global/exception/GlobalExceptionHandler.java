...
public class GlobalExceptionHandler {
    ...
    /**
     * 우리가 만든 CustomException이 발생했을 때 처리
     * (Service 계층에서 throw new CustomException(ErrorCode.FACILITY_NOT_FOUND); 할 때 잡힘)
     */
    ...
    /**
     * Validation (@Valid) 검사 실패 시 처리
     * (Controller에서 DTO 입력값 형식이 틀렸을 때 잡힘)
     */
