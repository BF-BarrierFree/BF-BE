 ...
 * 약관은 불변(immutable) 개정판(revision)으로 관리되며, 변경 시 새로운 레코드를 생성합니다.
 */
@Entity
@Table(name = "terms")
@Getter
...
public class Term extends BaseEntity {
    ...
    @Builder
    public Term(String title, String content, boolean isRequired, boolean isActive, Integer version, LocalDateTime effectiveDate) {
        this.title = title;
