...
public class TaxiCenter extends BaseEntity {
  ...
  public TaxiCenter(
      ...
      String appName,
      String weekdayReservationStartTime,
      String weekdayReservationEndTime,
      String weekdayOperationStartTime,
      String weekdayOperationEndTime,
      String weekendOperationYn,
      String weekendOperationExplanation,
      String withinRegionName,
      String outsideRegionName,
      String targetExplanation,
      String dailyUsageLimit,
      String advanceReservationExplanation,
      String basicChargeExplanation,
      String extraChargeExplanation,
