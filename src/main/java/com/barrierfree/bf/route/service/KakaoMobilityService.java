...
public class KakaoMobilityService {
  ...
  public String testKakaoDirections(
    ...
    String priorityParam =
        (priority != null && !priority.trim().isEmpty()) ? priority.trim() : "RECOMMEND";
  ...
  /** [테스트용] 카카오 내비 미래 운행 정보 길찾기 API 호출 과거 교통량 패턴을 기반으로 미래의 특정 출발 시간에 대한 경로 및 ETA를 예측합니다. */
  ...
  /** [내부 로직] 회피 옵션 포맷팅 카카오 API 스펙에 맞게 다중 회피 옵션을 파이프(|)로 연결하여 반환합니다. */
