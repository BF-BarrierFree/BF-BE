...
/** AI가 생성한 코스 조합 결과를 프론트엔드에 미리보기로 전달하기 위한 응답 DTO 이 데이터는 아직 DB에 저장되지 않은 상태입니다. */
@Builder
public record AiCoursePreviewResponse(
    String courseTitle, // 임시로 생성된 코스 제목 (예: "제주 자연·휴식 코스")
  ...
  public static AiCoursePreviewResponse of(
      String courseTitle, int totalDays, List<AiCoursePlacePreview> places) {
