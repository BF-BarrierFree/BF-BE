...
public record AiCourseGenerateRequest(
    @NotNull(message = "지역을 선택해주세요.") CourseRegion region,
    @NotNull(message = "동행자를 선택해주세요.") CourseCompanion companion,
    ...
    @NotNull(message = "여행 테마를 선택해주세요.") CourseTheme theme,
    @NotNull(message = "여행 일정을 선택해주세요.") CourseDuration duration) {}
